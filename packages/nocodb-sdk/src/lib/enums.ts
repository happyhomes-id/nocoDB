...
export enum WorkspaceUserRoles {
  ...
  LIMITED = 'workspace-level-limited',
...
export const RoleLabels = {
  ...
  [WorkspaceUserRoles.LIMITED]: 'limited',
...
export const RoleColors = {
  ...
  [WorkspaceUserRoles.LIMITED]: 'orange',
...
export const RoleDescriptions = {
  ...
  [ProjectRoles.LIMITED]: 'Can view records and add comment on them',
...
export const RoleIcons = {
  ...
  [WorkspaceUserRoles.LIMITED]: 'role_limited',
  ...
  [ProjectRoles.LIMITED]: 'role_limited',
...
export const WorkspaceRolesToProjectRoles = {
  ...
  [WorkspaceUserRoles.LIMITED]: ProjectRoles.LIMITED,
